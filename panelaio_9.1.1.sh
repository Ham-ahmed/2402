...
echo -e "${CYAN}"
echo "################################################################"
echo "#        Start downloading and installing panelaio_9.1.1       #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/2402/refs/heads/main/enigma2-plugin-extensions-panelaio_9.1.1_all.ipk"
IPK_NAME="enigma2-plugin-extensions-panelaio_9.1.1_all.ipk"
