...
echo -e "${CYAN}"
echo "################################################################"
echo "#        Start downloading and installing ncam_V15.7-r0        #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/2402/refs/heads/main/enigma2-plugin-softcams-ncam_V15.7-r0_all.ipk"
IPK_NAME="enigma2-plugin-softcams-ncam_V15.7-r0_all.ipk"
