...
echo -e "${CYAN}"
echo "################################################################"
echo "#        Start downloading and installing xklass_1.76          #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/2402/refs/heads/main/enigma2-plugin-extensions-xklass_1.76.20260222_all.ipk"
IPK_NAME="enigma2-plugin-extensions-xklass_1.76.20260222_all.ipk"
