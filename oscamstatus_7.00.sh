...
echo -e "${CYAN}"
echo "################################################################"
echo "#        Start downloading and installing oscamstatus_7.00     #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/2402/refs/heads/main/enigma2-plugin-extensions-oscamstatus_7.00_all.ipk"
IPK_NAME="enigma2-plugin-extensions-oscamstatus_7.00_all.ipk"
